...
const Webcomponentsdotorg = React.forwardRef(function Webcomponentsdotorg({ color = 'currentColor', size = 24, title = "webcomponentsdotorg", ...others }, ref) {
...
export { Webcomponentsdotorg as default };
