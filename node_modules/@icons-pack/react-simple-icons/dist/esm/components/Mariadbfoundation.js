...
const Mariadbfoundation = React.forwardRef(function Mariadbfoundation({ color = 'currentColor', size = 24, title = "mariadbfoundation", ...others }, ref) {
...
export { Mariadbfoundation as default };
