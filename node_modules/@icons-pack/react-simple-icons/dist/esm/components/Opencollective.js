...
const Opencollective = React.forwardRef(function Opencollective({ color = 'currentColor', size = 24, title = "opencollective", ...others }, ref) {
...
export { Opencollective as default };
