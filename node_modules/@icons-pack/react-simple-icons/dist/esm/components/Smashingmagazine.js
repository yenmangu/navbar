...
const Smashingmagazine = React.forwardRef(function Smashingmagazine({ color = 'currentColor', size = 24, title = "smashingmagazine", ...others }, ref) {
...
export { Smashingmagazine as default };
