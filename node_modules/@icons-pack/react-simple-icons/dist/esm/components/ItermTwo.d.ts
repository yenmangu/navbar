...
export declare type ItermTwoProps = React.ComponentPropsWithoutRef<'svg'> & {
    /**
...
export default ItermTwo;
//# sourceMappingURL=ItermTwo.d.ts.map