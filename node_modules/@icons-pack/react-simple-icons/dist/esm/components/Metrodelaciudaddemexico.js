...
const Metrodelaciudaddemexico = React.forwardRef(function Metrodelaciudaddemexico({ color = 'currentColor', size = 24, title = "metrodelaciudaddemexico", ...others }, ref) {
...
export { Metrodelaciudaddemexico as default };
