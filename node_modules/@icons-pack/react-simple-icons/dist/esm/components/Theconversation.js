...
const Theconversation = React.forwardRef(function Theconversation({ color = 'currentColor', size = 24, title = "theconversation", ...others }, ref) {
...
export { Theconversation as default };
